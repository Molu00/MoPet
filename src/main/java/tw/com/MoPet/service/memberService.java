...
import tw.com.MoPet.model.memberRepository;
...
public class memberService {
	...
	public member findById(Integer id) {
		Optional<member> optional = memDao.findById(id);
	...
	public void sendEmail(String toEmail, String subject, member mem) throws MessagingException {
		...
		String template="<b>Hey ${UserName}</b>,<br><i>請按下以下連結設定密碼</i><br><a href='http://localhost:8080/MoPet/member/verification?id=${id}'>請按下我認證</a>";
