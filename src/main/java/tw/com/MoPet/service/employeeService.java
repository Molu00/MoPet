...
public class employeeService {
	...
	public Page<employee> findByPage(Integer pageNumber) {
		Pageable pgb = PageRequest.of(pageNumber - 1, 4, Sort.Direction.ASC, "empId");
		Page<employee> page = empDao.findAll(pgb);
		return page;
	}
