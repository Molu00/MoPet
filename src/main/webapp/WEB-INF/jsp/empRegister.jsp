				...
				<form method="post" action="employee/insert"
					...
					<div class="form-group">
						<label for="inputAddress">Email 帳號</label> <input type="text"
							...
							placeholder="you@gmail.com" name="email" required> <small
							id="passwordHelpInline" class="text-muted"> Must be 8-20
							characters long. </small>
					</div>

					<div class="form-group">
						<label for="inputCharacter">角色</label> <select
							class="custom-select" name="character" required>
					...
					<div class="form-group">
						<label for="inputstart_date">到職日</label> <input type="date"
